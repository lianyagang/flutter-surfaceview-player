...
public abstract class LifeVideoView implements GSYMediaPlayerListener {
    ...
    ///缓存回调
    public static final int CURRENT_BUFFERING_UPDATE = 8;
    ...
    protected String TAG = "LifeVideoView";

    public LifeVideoView(@NonNull Context context) {
        init(context);
    }

    public LifeVideoView(@NonNull Context context, @Nullable AttributeSet attrs) {
        init(context);
    }

    public LifeVideoView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        init(context);
    }

    public LifeVideoView(Context context, Boolean fullFlag) {
    ...
    protected void onLossAudio() {
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            public void run() {
                if (LifeVideoView.this.mReleaseWhenLossAudio) {
                    LifeVideoView.this.releaseVideos();
                } else {
                    LifeVideoView.this.onVideoPause();
                }
